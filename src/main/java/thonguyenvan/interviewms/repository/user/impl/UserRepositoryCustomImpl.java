package thonguyenvan.interviewms.repository.user.impl;
...
import thonguyenvan.interviewms.repository.user.UserRepositoryCustom;
...
public class UserRepositoryCustomImpl implements UserRepositoryCustom {
    ...
    public List<RoleListDTO> getRolesById(Integer id) {
        return entityManager.createQuery("select thonguyenvan.interviewms.util.dto.user.RoleListDTO(r.roleName) from User  u join u.roles r where u.id=:id",RoleListDTO.class )
                .setParameter("id",id)
                .getResultList();
    }
}
