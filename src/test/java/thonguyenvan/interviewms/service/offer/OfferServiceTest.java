...
import thonguyenvan.interviewms.repository.offer.Impl.OfferRepositoryCustomImpl;
...
import thonguyenvan.interviewms.service.offer.impl.OfferServiceImpl;
...
//            when(offerRepository.findByContractPeriodFromBetween(startDate, endDate)).thenReturn(list);
        }
        @Test
